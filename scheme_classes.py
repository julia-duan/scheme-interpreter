...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        if symbol in self.bindings:
            ...
            return self.parent.lookup(symbol) #syntax is very key... also recursion in case the parent has a parent, etc.
        else:
        # END PROBLEM 1
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 8
        frame = Frame(self)
        copy_formals = formals
        copy_vals = vals
        while copy_formals is not nil:
            frame.bindings[copy_formals.first] = copy_vals.first
            copy_formals = copy_formals.rest
            copy_vals = copy_vals.rest
        return frame
        # END PROBLEM 8
